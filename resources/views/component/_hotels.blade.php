            ...
            <div class="main-content--inner">
                <div class="content-inner">
                    ...
                    <div class="flex-responsive">
                        <div class="hotel__filtering">
                            <form action="">
                                <h2 class="ttl">Filter by:</h2>
                                <div class="filter-inner">
                                    <h3 class="ttl2">Popular filters</h3>
                                    <dl>
                                        <dd><input id="item1" type="checkbox"><label for="">Hotels</label></dd>
                                        <dd><label for="item1">284</label></dd>
                                    </dl>
                                </div>
                            </form>
                        </div>
